       ...
       // TODO
        for (Processor processor : processors) {
            try {
                ...
                // Handle the HaltProcessingException
                log.info("Processing halted: " + e.getMessage());
                break; // Stop processing further if HaltProcessingException is thrown
            } catch (Throwable throwable) {
                // Catch other exceptions and log them
                log.warn("Error during processor execution: ", throwable);
            }
        }
    }
}
